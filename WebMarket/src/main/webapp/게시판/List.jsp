...
/////////////////////////////////////////////////////////////////////////////////////////페이징
List<List<BoardDTO>> paged = new ArrayList();  //게시글 전체 받아오기

if(request.getParameter("pp")!=null){ //보여줄 게시글 수를 셀렉터로 받아옴
...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->   
    ...
    <% 
    	...
    	int z=gos!=null?Integer.parseInt(gos):0; //페이지 시작값 //tennum은 위로 올려보내서 tennum번째 게시글 리스트
    	
    	
//     	out.println("z : " +z +"<br>");    //// &
    	out.println("<a href=\"List.jsp?tennum="+1+
    	"&go="+0+"\" style= \" color:#666565;border:0; background-color:#E7E7E7; margin-right:10px; font-size:1.5px;\"class=\"btn btn-secondary\">"+"◀"+"</a>");
    	if(z!=0){out.println("<a href=\"List.jsp?tennum="+(z)+
    	...
    	for(int i=0; i<shows; i++){ 
    		z++;    
    		if(z==tennum+1){out.println("<a href=\"List.jsp?tennum="+z+
    				"\"  class=\"btn btn-secondary\"><b>"+z+"</b></a>");}
    		else{out.println("<a href=\"List.jsp?tennum="+z+
    	...
    	if(z<pag){out.println("<a href=\"List.jsp?tennum="+(z+1)+"&go="+z+"\" style=\"color:#666565;border:0; background-color:#E7E7E7;\" class=\"btn btn-secondary\">"+">"+"</a>");}
    	else{out.println("<a style=\"color:#666565;border:0; background-color:#E7E7E7;\"  class=\"btn btn-secondary\">"+"<b>"+">"+"</b>"+"</a>");}
    	out.println("<a href=\"List.jsp?tennum="+pag+"&go="+last+"\" style= \" color:#666565;border:0; background-color:#E7E7E7; margin-left:10px; font-size:1.5px;\" class=\"btn btn-secondary\">"+"▶"+"</a>");
...
<!--     		<button type="button" class="btn btn-secondary" onclick="location.href='remove.jsp?remove=member';">멤버리셋</button> -->
        ...
        <div align="right" style="width:30%; margin-right:7%; margin-bottom:3%;">          	
