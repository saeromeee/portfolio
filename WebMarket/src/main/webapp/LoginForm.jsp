...
<!-- 	//이거 ㅅㅂ 게시판 안에서는 되는데 장바구니에서는 ./게시판/LoginProcess.jsp로 주소잡아야됨 -->
	<form style = "float:right;" action = "LoginProcess.jsp?log=<%  
		if(log!=null){
			out.print("1");
		} else {out.print("0");}
	%>"	
	 method="post" name="LoginFrm" onsubmit="return validateForm(this);" style="margin-left:50%;" >		
		<div align="right">	
			<div class="form-floating" style="display:flex; width:350px;" align="right">
		  	...
		  	<div class="form-floating" style="width:220px; margin-left:125px; display:flex;"  >	 
		  	 	<%if(sign!=null){%>
		  	 	<p style="margin-left:80px;"><input type="submit" class="btn btn-secondary" value="회원 등록" />
		  	 	<%} else {%>
			  	<p><input type="button" class="btn btn-secondary" onclick="location.href='product.jsp?sign=1';" value="회원가입" />	
